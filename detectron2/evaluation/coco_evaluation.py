...
from detectron2.evaluation.confusion_matrix import ConfusionMatrix,xywh2xyxy,process_batch,ap_per_class
...
def _evaluate_predictions_on_coco(
    ...
    #     C_M.print()
        ...
        # plot_dir = "C:/Users/admin/Desktop/detectron2-windows/ferrite/output"
        #
        # names = {k: v for k, v in enumerate(["ferrite"])}
        # stats = [np.concatenate(x, 0) for x in zip(*stats)]  # to numpy
        # if len(stats) and stats[0].any():
        #     p, r, ap, f1, ap_class = ap_per_class(*stats, plot=True, save_dir=plot_dir, names=names)
        # C_M.plot(save_dir=plot_dir+ 'confusion_matrix_rec.png',names=["ferrite"], rec_or_pred=0)
        # C_M.plot(save_dir=plot_dir+ 'confusion_matrix_pred.png',names=["ferrite"], rec_or_pred=1)
